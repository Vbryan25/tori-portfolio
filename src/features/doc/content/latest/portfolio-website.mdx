...
One note on process: I'm using Claude for a lot of the heavy lifting, but I've made it a conscious effort to understand everything it's doing and how the pieces compose. I hand coded a badge component myself, a simple one, on purpose. My rule is that if I could build the thing without Claude, then I don't feel bad having Claude speed it up. So I made myself learn to build components in TypeScript first.

## The rapid fire reviews

At Proctorio we self hosted everything for security reasons, so I never got to experiment with the big name platforms. This week I finally did. Here's every one, pros and cons.
...
I've been playing with this one for four or five months, and I used it alongside shadcn themes when ideating the design system for my dashboard project.
