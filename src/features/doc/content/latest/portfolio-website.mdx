...
<Figure
  ...
  alt="A case study page from the Astro concept, showing a dark glass panel over a painterly background with a tabbed Problem/Approach/Process/Outcome layout"
  caption="A case study page from the Astro concept: dark glass panels over a painterly background, tabbed Problem/Approach/Process/Outcome."
/>
