...
I started my first portfolio redesign as a Framer site and honestly, it's good for what it's built for. It was an easy transition from Webflow and it provides you a great canvas editing view. The CMS is really nice, and I see the value in it as a product. But I couldn't edit code components inside Framer as easily as I wanted to, and that got frustrating fast. Sometimes it would render what I designed on the canvas when I wanted the code component, and then when I finally got it using the code component, I'd be fighting to get it back to the canvas version. I needed more control than the platform wanted to give me.
...
<Figure
  ...
  caption="The interaction spec, mapped out in Figma before any of it existed in Framer."
/>
